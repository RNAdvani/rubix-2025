            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-3 text-center p-4 rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <p className="text-sm text-gray-600">
                  Hold onto every precious memory before it fades, and send it
                  back when they're older.
                </p>
              </div>
              ...
              <div className="space-y-3 text-center p-4 rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <p className="text-sm text-gray-600">
                  Capture growth, dreams, and early journeys as you navigate
              ...
              <div className="space-y-3 text-center p-4 rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <p className="text-sm text-gray-600">
                  Ensure your stories live on—share them with exactly who you
                  choose, and when you want it delivered.
                </p>
              </div>
              ...
              <div className="space-y-3 text-center p-4 rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <p className="text-sm text-gray-600">
                  Preserve the dreams, hopes, and memories that make this moment
                  unique, and capture who you are today for your future self.
                </p>
              </div>
              ...
              <div className="space-y-3 text-center p-4 rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <p className="text-sm text-gray-600">
                  For the big moments that matter the most—keep those memories
              ...
              <div className="space-y-3 text-center p-4 rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <p className="text-sm text-gray-600">
                  Even when you're no longer by their side, continue to share
                  your love, wisdom, and memories for the future.
                </p>
              </div>
            </div>
          </div>
